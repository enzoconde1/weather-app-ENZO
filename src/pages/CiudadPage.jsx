...
const listaItemsPronosticoEx = [
  ...
  { hora: 12, estado: 'clear', temperatura: 18, dia: 'Viernes' },
  { hora: 18, estado: 'rain', temperatura: 19, dia: 'Viernes' },
  { hora: 14, estado: 'drizzle', temperatura: 17, dia: 'Sábado' },
  { hora: 15, estado: 'thunderstorm', temperatura: 17, dia: 'Sábado' },
];
